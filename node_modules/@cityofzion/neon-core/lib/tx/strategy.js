 ...
 * @return {Coin[]}
 */
export function smallestFirst(assetBalance, requiredAmt) {
 ...
 * @return {Coin[]}
 */
export function biggestFirst(assetBalance, requiredAmt) {
 ...
 * @return {Coin[]}
 */
export function balancedApproach(assetBalance, requiredAmt) {
